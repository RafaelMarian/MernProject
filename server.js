...
function passwordProtected(req, res, next) {
    res.set("WWW-Authenticate", "Basic real='Our Mern App'")
    if (req.headers.authorization == "Basic 1213122") {
        next()
    } else {
...
app.delete("/animal/:id", async (req, res) => {
    ...
    db.collection("animals").deleteOne({ _id: new ObjectId(req.params.od) })
})
